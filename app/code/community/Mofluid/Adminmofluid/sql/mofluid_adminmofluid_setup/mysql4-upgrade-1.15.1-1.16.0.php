...
INSERT INTO {$this->getTable('adminmofluid/mofluidresource')} (module, resource_name, resource, version, scope, sendbuildmode) VALUES ('Mofluid_Adminmofluid','adminmofluid_setup','{$this->getTable('adminmofluid/mofluidresource')}','1.14.2','Mofluid Resorce',0);
INSERT INTO {$this->getTable('adminmofluid/mofluidresource')} (module, resource_name, resource, version, scope, sendbuildmode) VALUES ('Mofluid_MofluidApi','','','1.14.2','Mofluid API',0);
");
$installer->endSetup();
?>
