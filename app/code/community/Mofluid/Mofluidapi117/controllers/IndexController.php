...
*  Subpackage      :     Mofluidapi117
*  Package         :     Mofluid
*  Description     :     Mofluidapi117 is plugin for magento to communicate with mofluid Application
...
class Mofluid_Mofluidapi117_IndexController extends Mage_Core_Controller_Front_Action
{
        ...
        try {
            ...
            if ($store == -1 || $store == null || $store == "") {
                ...
                if ($service == "sidecategory") {
                    ...
                    $res = $ws_service->getallCMSPages($store, $pageId);
                    echo $_GET["callback"] . '(' . json_encode($res) . ');';
