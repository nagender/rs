...
*  Package         :     Mofluid
*  Description     :     Mofluidapi118 is plugin for magento to communicate with mofluid Application
...
class Mofluid_Mofluidapi118_IndexController extends Mage_Core_Controller_Front_Action
{
