...
INSERT INTO {$this->getTable('adminmofluid/mofluidresource')} (module, resource_name, resource, version, sendbuildmode) VALUES ('Mofluid_Mofluidpush','mofluidpush_setup','{$this->getTable('mofluidpush/mofluidpush')}','1.14.2',0);

INSERT INTO {$this->getTable('adminmofluid/mofluidresource')} (module, resource_name, resource, version, sendbuildmode) VALUES ('Mofluid_Mofluidpush','mofluidpush_setup','{$this->getTable('mofluidpush/mofluidpush_settings')}','1.14.2',1);
