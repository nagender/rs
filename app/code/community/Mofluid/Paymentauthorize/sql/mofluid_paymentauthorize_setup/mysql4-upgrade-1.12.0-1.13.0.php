...
INSERT INTO {$this->getTable('adminmofluid/mofluidresource')} (module, resource_name, resource, version, scope, sendbuildmode) VALUES ('Mofluid_Payment','mofluid_payment_setup','{$this->getTable('mofluid_paymentauthorize/payment')}','1.13.0','Payment',1);
