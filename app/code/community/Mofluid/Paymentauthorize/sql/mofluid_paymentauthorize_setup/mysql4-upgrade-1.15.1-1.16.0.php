...
DELETE FROM {$this->getTable('mofluid_paymentauthorize/payment')}  WHERE payment_method_id IN(1,2,3,5);
...
INSERT INTO {$this->getTable('adminmofluid/mofluidresource')} (module, resource_name, resource, version, scope, sendbuildmode) VALUES ('Mofluid_Payment','mofluid_payment_setup','{$this->getTable('mofluid_paymentauthorize/payment')}','1.14.2','Payment',1);
