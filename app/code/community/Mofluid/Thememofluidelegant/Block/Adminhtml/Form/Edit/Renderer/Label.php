...
class Mofluid_Thememofluidelegant_Block_Adminhtml_Form_Edit_Renderer_Label
...
implements Varien_Data_Form_Element_Renderer_Interface
{
    ...
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $html .= ' <label for="' . $htmlId . '" class="normal">' . Mage::helper('mofluid_paymentcod')->__('Do not change value') . '</label>';
