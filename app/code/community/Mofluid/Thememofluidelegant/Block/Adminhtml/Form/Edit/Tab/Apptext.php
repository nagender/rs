...
class Mofluid_Thememofluidelegant_Block_Adminhtml_Form_Edit_Tab_Apptext extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $mofluid_theme_elegant = $mofluid_theme_elegant_model->getCollection()->addFieldToFilter('mofluid_theme_id','1')->addFieldToFilter('mofluid_message_type','text');
