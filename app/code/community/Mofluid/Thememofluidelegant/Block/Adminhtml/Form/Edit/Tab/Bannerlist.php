...
class Mofluid_Thememofluidelegant_Block_Adminhtml_Form_Edit_Tab_Bannerlist extends Mage_Adminhtml_Block_Widget_Grid
{
     ...
     * @return Mofluid_Thememofluidelegant_Block_Adminhtml_Form_Edit_Tab_Bannerlist
     */
    ...
    protected function _prepareCollection()
    {
       ...
       $mofluid_theme_elegant_banner = $mofluid_theme_elegant_model->getCollection()->addFieldToFilter('mofluid_theme_id', '1')->addFieldToFilter('mofluid_image_type','banner');
	  $this->setCollection($mofluid_theme_elegant_banner);
    ...
    protected function _prepareColumns()
    {
       ...
       $this->addColumn('mofluid_theme_banner_image_store', array(
            ...
            'renderer'  => 'Mofluid_Thememofluidelegant_Block_Adminhtml_Form_Edit_Renderer_Store'
        ));
