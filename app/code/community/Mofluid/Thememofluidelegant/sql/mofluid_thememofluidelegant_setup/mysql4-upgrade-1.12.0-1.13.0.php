...
INSERT INTO  {$this->getTable('mofluid_thememofluidelegant/mofluid_themes_images')} VALUES ( 1, 0, 300001, 'logo', 'Logo ', 'http://125.63.92.59/Mofluid/Production1.13.0/Default_Assets/Android/logo_banner/logo.png', 'Upload your application logo displayed in the app (Recommended Size : 150X50px).', '', 1, 0, 0 ,'','');
INSERT INTO  {$this->getTable('mofluid_thememofluidelegant/mofluid_themes_images')} VALUES ( 1, 0, 300002, 'banner', 'Banner ', 'http://125.63.92.59/Mofluid/Production1.13.0/Default_Assets/Android/logo_banner/banner.png', 'Upload your application banner displayed in the app (Recommended Size : 420x260px).', '', 1, 0, 1 ,'','');
