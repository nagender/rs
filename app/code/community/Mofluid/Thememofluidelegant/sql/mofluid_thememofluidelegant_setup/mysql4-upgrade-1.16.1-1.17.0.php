...
INSERT INTO {$this->getTable('mofluid_thememofluidelegant/mofluid_themes_core')} (`mofluid_theme_id`, `mofluid_theme_code`, `mofluid_theme_title`, `mofluid_theme_status`, `mofluid_theme_display_custom_attribute`,`google_ios_clientid`,`google_login`,`cms_pages`,`about_us`,`term_condition`,`privacy_policy`,`return_privacy_policy`,`tax_flag`) VALUES ( 1, 'elegant', 'Elegant', 1, 0,'','0','0','','','','','0');
...
INSERT INTO  {$this->getTable('mofluid_thememofluidelegant/mofluid_themes_messages')} VALUES ( 1, 0, 100029, 'button', 'Update Cart', 'Update Cart', 'This text will displayed to update cart', '', 1);
...
INSERT INTO  {$this->getTable('mofluid_thememofluidelegant/mofluid_themes_messages')} VALUES ( 1, 0, 200054, 'alert', 'Products Out of Stock message', 'Some products in your cart has been out of stock or we do not have required quantity at this time.', 'This text will appear when placing the order and we do not have required quantity available.', '', 1);
...
INSERT INTO  {$this->getTable('mofluid_thememofluidelegant/mofluid_themes_messages')} VALUES ( 1, 0, 300094, 'text', 'General', 'General', 'This text will appear on product detail page.', '', 1);
INSERT INTO  {$this->getTable('mofluid_thememofluidelegant/mofluid_themes_messages')} VALUES ( 1, 0, 300095, 'text', 'Short Description', 'Short Description', 'This text will appear on product detail page.', '', 1);
INSERT INTO  {$this->getTable('mofluid_thememofluidelegant/mofluid_themes_messages')} VALUES ( 1, 0, 300096, 'text', 'Full Description', 'Full Description', 'This text will appear on product detail page.', '', 1);
INSERT INTO  {$this->getTable('mofluid_thememofluidelegant/mofluid_themes_messages')} VALUES ( 1, 0, 300097, 'text', 'Payment Canceled', 'Sorry your payment has been canceled.', 'This text will appear when payment has been canceled.', '', 1);
INSERT INTO  {$this->getTable('mofluid_thememofluidelegant/mofluid_themes_messages')} VALUES ( 1, 0, 300098, 'text', 'Reviews', 'Reviews', 'This text will appear on product detail page.', '', 1);
INSERT INTO  {$this->getTable('mofluid_thememofluidelegant/mofluid_themes_messages')} VALUES ( 1, 0, 300099, 'text', 'Order Summary', 'Order Summary', 'This text will appear on order invoice page.', '', 1);
INSERT INTO  {$this->getTable('mofluid_thememofluidelegant/mofluid_themes_messages')} VALUES ( 1, 0, 300100, 'text', 'Date', 'Date', 'This text will appear on order invoice page.', '', 1);
INSERT INTO  {$this->getTable('mofluid_thememofluidelegant/mofluid_themes_messages')} VALUES ( 1, 0, 300101, 'text', 'Message for invalid payment amount', 'Invalid amount for payment processing.', 'This text will appear on payment page when invalid amount.', '', 1);
INSERT INTO  {$this->getTable('mofluid_thememofluidelegant/mofluid_themes_messages')} VALUES ( 1, 0, 300102, 'text', 'including tax', 'Inc. Tax', 'This text will appear on product detail.', '', 1);
INSERT INTO  {$this->getTable('mofluid_thememofluidelegant/mofluid_themes_messages')} VALUES ( 1, 0, 300103, 'text', 'excluding tax', 'Ex Tax', 'This text will appear on product detail.', '', 1);
...
INSERT INTO  {$this->getTable('mofluid_thememofluidelegant/mofluid_themes_images')} VALUES ( 1, 0, 300001, 'logo', 'Logo ', 'http://54.169.219.183/Mofluid/Production1.17.0/Default_Assets/Android/logo_banner/logo.png', 'Upload your application logo displayed in the app (<b>Recommended Size : 150X50px</b>).', '', 1, 0, 0 ,'','');
INSERT INTO  {$this->getTable('mofluid_thememofluidelegant/mofluid_themes_images')} VALUES ( 1, 0, 300002, 'banner', 'Banner ', 'http://54.169.219.183/Mofluid/Production1.17.0/Default_Assets/Android/logo_banner/banner1.png', 'Upload your application banner displayed in the app (<b>Recommended Size : 1024x500px</b>).', '', 1, 0, 1 ,'','');
INSERT INTO  {$this->getTable('mofluid_thememofluidelegant/mofluid_themes_images')} VALUES ( 1, 0, 300003, 'banner', 'Banner ', 'http://54.169.219.183/Mofluid/Production1.17.0/Default_Assets/Android/logo_banner/banner2.png', 'Upload your application banner displayed in the app (<b>Recommended Size : 1024x500px</b>).', '', 1, 0, 1 ,'','');
INSERT INTO  {$this->getTable('mofluid_thememofluidelegant/mofluid_themes_images')} VALUES ( 1, 0, 300004, 'banner', 'Banner ', 'http://54.169.219.183/Mofluid/Production1.17.0/Default_Assets/Android/logo_banner/banner3.png', 'Upload your application banner displayed in the app (<b>Recommended Size : 1024x500px</b>).', '', 1, 0, 1 ,'','');
