...
/**
 * File path:
 * magento_root/app/code/local/Mofluid/Thememofluidmodern/Block/Adminhtml/Entityname/Edit/Form/Renderer/Fieldset/Customtype.php
 */
class Mofluid_Thememofluidmodern_Block_Adminhtml_Form_Edit_Renderer_Custombutton 
