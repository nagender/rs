<?php
class Mofluid_Thememofluidmodern_Block_Adminhtml_Form_Edit_Tab_Banner extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * prepare form in tab
     */
    protected function _prepareForm() 
    {
	    ...
	    $mofluid_modern_config_model_settings = Mage::getModel('mofluid_thememofluidmodern/thememofluidmodern')->getCollection()->addFieldToFilter('mofluid_theme_id','2')->addFieldToFilter('mofluid_theme_code','modern')->getData();
	    $mofluid_theme_banner_image_type = $mofluid_modern_config_model_settings[0]['mofluid_theme_banner_image_type'];
	    $mofluid_theme_modern_model = Mage::getModel('mofluid_thememofluidmodern/images');
	    $mofluid_theme_modern_banner = $mofluid_theme_modern_model->getCollection()->addFieldToFilter('mofluid_image_type','banner');
	    $mofluid_theme_modern_banner_data = $mofluid_theme_modern_banner->getData(); 
	    ...
	    $themebanner_add_fieldset->addType('custombutton', 'Mofluid_Thememofluidmodern_Block_Adminhtml_Form_Edit_Renderer_Custombutton');
	    $themebanner_fieldset->addType('image', 'Mofluid_Thememofluidmodern_Block_Adminhtml_Form_Edit_Renderer_Image');
	    //$themebanner_fieldset->addType('image', Mage::getConfig()->getBlockClassName('Mofluid_Thememofluidmodern/Adminhtml_Form_Edit_Renderer_Image'));
