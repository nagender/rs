...
class Mofluid_Thememofluidmodern_Block_Adminhtml_Form_Edit_Tab_Buttontext extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $mofluid_theme_modern = $mofluid_theme_modern_model->getCollection()->addFieldToFilter('mofluid_theme_id','2')->addFieldToFilter('mofluid_message_type','button');
